        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" action="<?= BASE_URL?>/auth/regisPenumpang" method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="nama_penumpang"
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="alamat_penumpang"
                                placeholder="Alamat" id="alamatPenumpang">
                        </div>
                        <div class="form-group">
